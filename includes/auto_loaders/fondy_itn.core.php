...
/**
 * Include Fondy-specific functions
 * require( 'includes/modules/payment/fondy/fondy_functions.php' );
 */
$autoLoadConfig[60][] = array(
    'autoType'=>'include',
    'loadFile'=> DIR_WS_MODULES .'payment/fondy/fondy_common.inc' );
$autoLoadConfig[60][] = array(
    'autoType'=>'include',
    'loadFile'=> DIR_WS_MODULES .'payment/fondy/fondy_functions.php' );
...
$autoLoadConfig[71][] = array(
    'autoType'=>'init_script',
    'loadFile'=> 'init_fondy_itn_sessions.php' );
...
$autoLoadConfig[170][] = array(
    'autoType'=>'init_script',
    'loadFile'=> 'init_fondy_itn_postcfg.php' );
?>